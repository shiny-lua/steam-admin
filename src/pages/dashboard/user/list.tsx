...
const tempData = [
  {
    name: 'Jayvion Simon',
    level: 11,
    trade_link: "https://steamcommunity.com/tradeoffer/new/?partner=1851132226&token=gWH6wIfO",
    balance: 12,
    verified: true
  },
  {
                  ...
                  {tempData
                    ...
                    .map((row, key) => (
                      <UserTableRow
                        key={key}
                        row={row}
                        selected={selected.includes(key.toString())}
                        onSelectRow={() => onSelectRow(key.toString())}
                        onDeleteRow={() => handleDeleteRow(key.toString())}
